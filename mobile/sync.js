...
// Токен из общего config.js
const { YANDEX_TOKEN } = require(path.join(root, 'config.js'));
fs.writeFileSync(path.join(www, 'config.gen.js'), 'window.KV_TOKEN = ' + JSON.stringify(YANDEX_TOKEN) + ';\n');
