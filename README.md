...
Проще всего — установщик из [релизов](https://github.com/MortisClub/Kvinta/releases), он же будет обновляться сам.
...
Готовый APK лежит в [релизах](https://github.com/MortisClub/Kvinta/releases). В `mobile/www` — Capacitor-обёртка над тем же кодом, общие файлы синкаются командой `node mobile/sync.js`.
